...
def create_star_schema(df):
    ...
    if 'home_ownership' in df.columns:
        ...
        dim_tables['home_ownership_dim_August01'] = home_ownership_dim
    ...
    if 'loan_status' in df.columns:
        ...
        dim_tables['loan_status_dim_August01'] = loan_status_dim
    ...
    if 'issue_d' in df.columns:
        ...
        dim_tables['issue_d_dim_August01'] = issue_d_dim
...
def deploy_to_database(fact_table, dim_tables):
    ...
    try:
        ...
        fact_table.to_sql('loans_fact_August01', con=engine, if_exists='replace', index=False)
